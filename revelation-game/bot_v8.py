...
class StoryButton(Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        try:
            ...
            # FIX: Defer first to avoid timeout!
            ...
            if not next_scene_data:
                await interaction.followup.send(f"❌ Scene {self.next_scene} not found", ephemeral=True)
                return
            ...
            if next_scene_data.get('choices'):
                ...
                # Get original message and edit it
